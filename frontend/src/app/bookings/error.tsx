  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 md:p-10 flex flex-col justify-center items-center">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-sm border border-gray-100 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Could not load bookings</h2>
        <p className="text-gray-500 mb-8">We encountered an error while fetching your bookings. Please try again.</p>
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link
            href="/"
            className="w-full bg-gray-100 text-gray-700 font-semibold py-3 px-4 rounded-xl hover:bg-gray-200 transition block"
          >
            Return Home
          </Link>
        </div>
